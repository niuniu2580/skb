...
public class MoreActivity extends Activity {
	...
	private void setData() {
		...
		view = new MyView(MoreActivity.this);
	...
	public void showList(List<SortFoodItem> foodItem) {
		if (adapter == null) {
				...
				public void onPullDownToRefresh(PullToRefreshBase refreshView) {
					...
					handler.postDelayed(new Runnable() {
						...
						public void run() {
							...
							Toast.makeText(MoreActivity.this, "刷新成功！", Toast.LENGTH_SHORT).show();
			...
			adapter = new SortAdapter(MoreActivity.this,
					foodList);
	...
	public OnClickListener listener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.imageButton_back:
				intent.setClass(MoreActivity.this, SortActivity.class);
				intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(intent);
				break;
			case R.id.ImageButton_hangout:
				intent.setClass(MoreActivity.this, HangoutActivity.class);
				intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(intent);
				break;
